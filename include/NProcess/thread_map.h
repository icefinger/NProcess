...
#ifndef _MY_STL_MAP_H
#define _MY_STL_MAP_H 1
...
{//_GLIBCXX_BEGIN_NESTED_NAMESPACE(std, _GLIBCXX_STD_D)
  ...
  public:
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);
      const_iterator to_return=_M_t.end(); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    {
      // concept requirements
      pthread_mutex_lock(&_main_mutex2);
	...
	__i = insert(__i, value_type(__k, mapped_type()));
      mapped_type& to_return=(*__i).second;
      pthread_mutex_unlock(&_main_mutex2);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);
      std::pair<iterator, bool> to_return=_M_t._M_insert_unique(__x); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);
      iterator to_return=_M_t._M_insert_unique_(__position, __x); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);  
      size_type to_return=_M_t.erase(__x); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);  
      key_compare to_return=_M_t.key_comp(); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);  
      value_compare to_return=(_M_t.key_comp()); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);  
      iterator to_return=_M_t.find(__x); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      //pthread_mutex_lock(&_main_mutex);  
      const_iterator to_return=_M_t.find(__x); 
      //pthread_mutex_unlock(&_main_mutex);
      return to_return;
    }
    ...
    { 
      pthread_mutex_lock(&_main_mutex2);  
      size_type to_return=_M_t.find(__x) == _M_t.end() ? 0 : 1; 
      pthread_mutex_unlock(&_main_mutex2);
      return to_return;
    }
